...
/**
 * Sets whether the AuthProxy plugin will attempt to handle X509 challenges for the webview.  If
 * this method is never called, the default behaviour is to go by the preference in the config.xml
 * SAPKapselHandleX509Challenges.  If that preference is not set the default is to handle X509
 * challenges.
 * This method only does anything on Android.  If called on any other platform the success callback
